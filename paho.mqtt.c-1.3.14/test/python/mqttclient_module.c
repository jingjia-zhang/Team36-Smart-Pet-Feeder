/*
 * mqttclient_module.c – Python C extension for Eclipse Paho MQTTClient (synchronous) API.
 * Allows Python programs to connect, publish, and subscribe with blocking calls.
 */
